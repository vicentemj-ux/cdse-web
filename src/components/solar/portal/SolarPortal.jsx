  ...
  return (
    <div className="sp-app">
      ...
      <main className="sp-main">
        ...
        {activeView === 'post-sales' && <Suspense fallback={<div className="sp-loading sp-loading--module">Preparando continuidad del proyecto…</div>}><PostSales data={data} refresh={() => load(session)} isAdmin={isAdmin} profile={profile} onOpenProject={openProject} openProjectId={openProjectId} /></Suspense>}
